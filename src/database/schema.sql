...
'[
  ...
  {"type": "booking", "order": 3, "data": {"title": "Nhận báo giá", "button_text": "Gửi yêu cầu", "form_schema": [{"field_name": "full_name", "field _type": "text", "label": "Họ và tên", "required": true}, {"field_name": "phone", "field_type": "text", "label": "SĐT", "required": true}, {"field_name": "subservice_id", "field_type": "select", "label": "Loại xe", "required": true, "options": ["truck_bagac", "truck_1t5", "truck_2t"]}, {"field_name": "from_address", "field_type": "text", "label": "Điểm đi", "required": true}, {"field_name": "to_address", "field_type": "text", "label": "Điểm đến", "required": true}, {"field_name": "booking_date", "field_type": "date", "label": "Ngày chuyển", "required": true}, {"field_name": "booking_time", "field_type": "time", "label": "Giờ chuyển", "required": true}]}}
]'::jsonb);